...
class BaseStation():
    ...
    def __init__(self):
        ...
        self.roll_angle=0
        self.pitch_angle=0
        self.image_names = ['compass.png', 'horizon.png', 'battery.png'] # horizon cant be first, regular size is based on compass' size
    ...
    def get_rotated_and_shifted_horizon_image(self, angle, shift):
        src_im = self.images['horizon.png']
        size = src_im.getbbox()[2:]
    ...
    def update(self):
        ...
        self.pitch_angle += random.randrange(-2,2)
